...
export function LegalPage({title,children,lastUpdated='March 25, 2026'}:{title:string;children:React.ReactNode;lastUpdated?:string}) {
  return <div className={s.page}><header><a href="/concept"><img src={LOGO.onLight} alt="CaseDelta" width="150"/></a><a href="/concept">Back to the homepage</a></header><main><h1>{title}</h1><p className={s.date}>Last updated: {lastUpdated}</p>{children}</main><footer><a href="/concept/privacy">Privacy policy</a><a href="/concept/terms">Terms of service</a><span>© 2026 CaseDelta</span></footer></div>;
}
