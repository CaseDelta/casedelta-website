...
const ROWS = [
  { feat: "Ease of use", sx: "Prompt-based automation", other: "Requires setup and configuration", otherOk: true },
  { feat: "Workflow automation", sx: "Multi-step execution", other: "Basic automation workflows", otherOk: true },
  { feat: "Ai decision making", sx: "Context-aware reasoning", other: "Rule-based logic", otherOk: true },
  { feat: "Agent collaboration", sx: "Multi-agent orchestration", other: "Not supported", otherOk: false },
  { feat: "Customization", sx: "Instant trigger-based automation", other: "Delayed execution in workflows", otherOk: false },
];
...
export function WhySasonix() {
  return (
    <section style={{ background: SX.white, padding: "0 0 120px" }}>
      <Container>
        <SectionHead eyebrow="Why Sasonix?" title="Sasonix vs other tools" titleMaxW={520} />
        <div style={{ position: "relative", maxWidth: 940, margin: "56px auto 0" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: COLS, alignItems: "center" }}>
            ...
            <span style={{ padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "center", gap: 9 }}>
              ...
              <span style={{ fontFamily: SX.body, fontSize: 20, fontWeight: 600, letterSpacing: "-0.3px", color: SX.ink }}>Sasonix</span>
            </span>
            <span style={{ padding: "18px 22px", textAlign: "center", fontFamily: SX.body, fontSize: 16, fontWeight: 500, color: SX.ink }}>Others</span>
          </div>
          {/* rows */}
          {ROWS.map((r) => (
