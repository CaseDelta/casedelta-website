...
export function WhySasonix() {
  return (
    <section id="security" style={{ background: SX.surface, padding: "0 0 120px" }}>
      <Container>
        <Reveal>
        ...
        <Reveal amount={0.15} style={{ position: "relative", maxWidth: 940, margin: "56px auto 0" }}>
          ...
          <div aria-hidden style={{ position: "absolute", top: 0, bottom: 0, left: "calc(1/3.24*100%)", width: "calc(1.12/3.24*100%)", border: `2px solid ${SX.accent}`, borderRadius: 16, background: "var(--sx-accent-soft)", pointerEvents: "none" }} />
          {/* header */}
          <div style={{ display: "grid", gridTemplateColumns: COLS, alignItems: "center" }}>
            ...
            <span style={{ padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "center", gap: 9 }}>
              <span style={{ width: 24, height: 24, borderRadius: 7, background: SX.accent, display: "grid", placeItems: "center" }} aria-hidden><svg width="13" height="13" viewBox="0 0 24 24" fill={SX.onAccent}><path d="M12 3l3.2 5.5H8.8L12 3zM6 10.5l3.2 5.5H2.8L6 10.5zm12 0l3.2 5.5h-6.4L18 10.5z" /></svg></span>
