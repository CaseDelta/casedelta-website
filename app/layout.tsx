...
export const metadata: Metadata = {
  ...
  description:
    "CaseDelta is an AI associate for plaintiff law firms. Delta drives the tools you already run and works your real cases, so every answer is grounded in your matter. Your client data never leaves your firm.",
  keywords: [
    "legal AI",
  ...
  openGraph: {
    ...
    description:
      "An AI associate that knows every case. Delta drives the tools your firm already runs and works your real matters, and your client data never leaves your firm.",
  ...
  twitter: {
    ...
    title: "CaseDelta: AI Associate for Plaintiff Law Firms",
    description:
      "An AI associate that knows every case. Delta drives the tools your firm already runs and keeps your client data inside your walls. Built for plaintiff firms.",
